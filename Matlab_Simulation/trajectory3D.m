function [t,X,dX,X_bez,dX_bez]=trajectory3D(order_Bezier_curve)
    global X_i X_f dt r v0_rep v0_att O
    ...
    for m=1:1:4
        ...
        while norm(X_exit-x_f)>soglia
            switch m 
                case 1
                    v_a=v_att(X_prel1(:,end),x_f,d_G,v0_att); 
                    v_r=v_rep(X_prel1(:,end),Oi,d_O,v0_rep); 
                    v=v_a+v_r; 
